...
namespace Characters.CharacterActionCommands
{
    public class CurseSpell : NonSelfTargetedAction
    {
        ...
        public CurseSpell(GameObject actor, int buffIndex)
        {
        ...
        private IEnumerator TakeAction(int actionID, int actorID, ParticleEffectName particleEffectName, Transform targetTransform, Vector3 localPosition, Vector3 toDirection, Vector3 localScale, bool shouldEffectFollowTarget = true)
        {
            ...
            AfflictWithDebuff();
            targetIStatChangeDisplay.ShowBuffStart(buffIndex, EffectTime);
            ...
            if (!targetStatChangeHandler.HasZeroHitPoints
                && targetStatChangeHandler.ActiveStatChangingEffects.ContainsKey(buffIndex))
                targetIStatChangeDisplay.ShowBuffEnd(buffIndex);
        ...
        {
            targetStatChangeHandler.AddStatChangingEffect(buffIndex,
        ...
        {
            targetStatChangeHandler.RemoveStatChangingEffect(buffIndex);
        }
    }
}