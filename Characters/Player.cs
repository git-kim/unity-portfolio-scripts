...
namespace Characters
{
    public sealed partial class Player : Character
    {
        ...
        private static readonly int Idle1Hash = Animator.StringToHash("Idle 1");
        ...
        private PlayerTarget currentTargetComponent;
        private StatChangeHandler currentTargetStatChangeHandler;

        private int autoHitPointsRegeneration;
        private int autoManaPointsRegeneration;
        ...
        protected override void Awake()
        {
            ...
            StatChangeDisplay = FindObjectOfType<PlayerStatChangeDisplay>();
        ...
        public void SelectTarget(GameObject gO)
        {
            ...
            currentTargetComponent = gO.GetComponent<PlayerTarget>();
            currentTargetComponent.TargetIndicator.SetActive(true);
        }
        ...
        public void DeselectTarget()
        {
            ...
            currentTargetComponent.TargetIndicator.SetActive(false);
